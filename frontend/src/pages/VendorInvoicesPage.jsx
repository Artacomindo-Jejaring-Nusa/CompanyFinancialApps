                          ...
                          <td className="py-3.5 px-3 text-center">
                            <div className="flex items-center justify-center gap-1.5">
                              <button
                                ...
                                title="Lihat Detail Invoice & Breakdown"
                              >
                                <Eye size={14} />
                              </button>
                              ...
                              {item.status !== 'PAID' ? (
                                ...
                                <span className="text-xs text-emerald-600 font-semibold px-2 py-0.5 bg-emerald-50 rounded border border-emerald-100 flex items-center gap-1">
                                  <CheckCircle2 size={12} />
                                  <span>Lunas</span>
                                </span>
                              )}
